...
after moving the slider. With hotkey hooks disabled, repeat the save/relaunch
check to confirm settings persistence is independent. If saving fails, the page should show the amber
