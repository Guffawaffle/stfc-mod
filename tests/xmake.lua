...
do
    ...
    add_files("../mods/src/targeted_diagnostics.cc")
    add_files("../mods/src/targeted_diagnostic_registry.cc")
    ...
    add_files("../mods/src/patches/fleet_notification_diagnostics.cc")
