...
do
    ...
    add_files("../mods/src/patches/battle_ref_resolver.cc")
    ...
    add_files("../mods/src/patches/sync_battlelog_payload.cc")
    ...
    add_files("../mods/src/patches/system_view_session_model.cc")
