...
try {
    ...
    foreach ($fixture in @('boolean_settings', 'boolean_view', 'native_boolean_callback', 'page_catalog', 'page_sections', 'settings_search', 'choice_setting', 'slider_setting', 'shortcut_editor', 'galaxy_selection_pins')) {
