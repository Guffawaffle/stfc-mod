...
bool should_install_native_shortcut_pointer_callback_guards(bool hotkeys_enabled,
                                                            ScopelyShortcutPolicy scopely_shortcuts);
const char* native_shortcut_pointer_callback_guard_reason(bool hotkeys_enabled,
                                                          ScopelyShortcutPolicy scopely_shortcuts);
