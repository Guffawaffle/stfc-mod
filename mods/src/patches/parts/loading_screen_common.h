...
// An embedded background exists only when the builder explicitly supplies
// --bg_image. Ordinary downstream builds preserve the game's own background.
#ifndef STFC_HAS_EMBEDDED_LOADING_IMAGE
#define STFC_HAS_EMBEDDED_LOADING_IMAGE 0
#endif

#if STFC_HAS_EMBEDDED_LOADING_IMAGE
