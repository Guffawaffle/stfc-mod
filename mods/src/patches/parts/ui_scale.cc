 ...
 */
MH_HOOK(void, ScreenManager_UpdateCanvasRootScaleFactor_Hook, ScreenManager* _this)
{
  ScreenManager_UpdateCanvasRootScaleFactor_Hook_original(_this);
 ...
 */
MH_HOOK(void, CanvasController_Show, CanvasController* _this, int desiredEntryPoint, bool instant)
{
...
void InstallUiScaleHooks()
{
  ...
  if (!screen_manager_helper.isValidHelper()) {
    ...
    if (ptr_update_scale == nullptr) {
      ...
      MH_ATTACH(ptr_update_scale, ScreenManager_UpdateCanvasRootScaleFactor_Hook);
    }
  }
  ...
  if (!canvas_controller_helper.isValidHelper()) {
    ...
    if (ptr_canvas_show == nullptr) {
      ...
      MH_ATTACH(ptr_canvas_show, CanvasController_Show);
    }
  }
