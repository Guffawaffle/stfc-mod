...
- `.ax/ax.ps1`: stable entrypoint used by [`axf.workspace.json`](../axf.workspace.json)
- this README
- the repo-owned AXF manifests under [`manifests/`](../manifests)
...
3. Repo-owned command metadata lives in `manifests/` and the provider notes live
   in [`scripts/axf/README.md`](../scripts/axf/README.md).
